  ...
  return (
    <>
      <div className = "w-screen h-screen flex justify-center flex-col items-center gap-10">
        ...
        <NavLink to = "/" className = "border-black rounded-full w-1/6 h-10 font-bold text-lg bg-blue-200 border flex justify-center items-center" style = {{textDecoration: 'underline black'}}>Go back</NavLink>
      </div>
    </>
  );
}
